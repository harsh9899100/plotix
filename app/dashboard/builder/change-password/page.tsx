  ...
  return (
    <DashboardLayout>
      <div className="dashboard-main py-6 max-w-lg">
        ...
        <p className="page-subtitle mb-6">Keep your builder account secure.</p>
        <div className="card-flat p-6 space-y-5">
          <div className="flex items-center gap-3 p-4 bg-blue-50 border border-blue-100 rounded-xl">
            <Shield className="w-5 h-5 text-blue-500 flex-shrink-0"/>
            <p className="text-sm font-body text-blue-700">Minimum 8 characters with mixed case, numbers & symbols.</p>
          </div>
